...
public class BruteForcePrimeSeqGeneratorTest extends AbstractPrimeGeneratorTest{


    @BeforeEach
    public void setup() {
        executorService = Executors.newFixedThreadPool(10);
        target = new BruteForcePrimeSeqGenerator(executorService, uniqueNumberSeqCacheService);
    }
