...
public class OptimisedBruteForcePrimeSeqGeneratorTest extends AbstractPrimeGeneratorTest{


    @BeforeEach
    public void setup() {
        executorService = Executors.newFixedThreadPool(10);
        target = new OptimisedBruteForcePrimeSeqGenerator(executorService, uniqueNumberSeqCacheService);
    }
